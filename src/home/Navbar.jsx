            ...
            <div className="flex flex-wrap items-center justify-between max-w-[1160px] w-full py-7 mx-auto">
                ...
                <div className="flex space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
                    <div className="flex justify-between items-center  gap-[13px] ">
                        ...
                        {/* Github */}
                        <a href="https://github.com/markkybean" target="_blank" rel="noopener noreferrer">
                            <svg width="24" height="24" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {/* Insta */}
                        <a href="https://www.instagram.com/markkybean/" target="_blank" rel="noopener noreferrer">
                            <svg width="24" height="24" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {/* Linkedin */}
                        <a href="https://www.linkedin.com/in/mark-santos10/" target="_blank" rel="noopener noreferrer">
